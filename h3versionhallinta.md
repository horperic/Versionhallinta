...
GitHub ei ole git vaan se on verkkosivu projektien hostamiseen, jotka käyttävät git:iä. GitHub käyttää projektien organisointiin varastoja, yleensä yhtä varastoa käytetään yhden projek-
